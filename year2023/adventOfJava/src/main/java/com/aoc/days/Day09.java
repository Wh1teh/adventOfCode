...
public class Day09 implements DayInterface {

    public String solve(int part) {
        List<String> lines = ReadFile.getData(
                "src/main/java/com/aoc/data/day09" + (part == 0 ? "_sample" : "") + ".txt");
        if (lines == null || lines.size() == 0) {
            return "Day 09 is not available";
        }
        ...
        if (str.isEmpty())
            return "Day 09 part " + part + " is Unimplemented";
        return str.toString();
    }
