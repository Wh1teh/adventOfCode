...
public class Day05 implements DayInterface {

    public String solve(int part) {
        List<String> lines = ReadFile.getData(
                "src/main/java/com/aoc/data/day05" + (part == 0 ? "_sample" : "") + ".txt");
        if (lines == null || lines.size() == 0) {
            return "Day 05 is not available";
        }
        ...
        if (str.isEmpty())
            return "Day 05 part " + part + " is Unimplemented";
        return str.toString();
    }
