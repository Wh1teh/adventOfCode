...
public class Day07 implements DayInterface {

    public String solve(int part) {
        List<String> lines = ReadFile.getData(
                "src/main/java/com/aoc/data/day07" + (part == 0 ? "_sample" : "") + ".txt");
        if (lines == null || lines.size() == 0) {
            return "Day 07 is not available";
        }
        ...
        if (str.isEmpty())
            return "Day 07 part " + part + " is Unimplemented";
        return str.toString();
    }
