...
public class Day08 implements DayInterface {

    public String solve(int part) {
        List<String> lines = ReadFile.getData(
                "src/main/java/com/aoc/data/day08" + (part == 0 ? "_sample" : "") + ".txt");
        if (lines == null || lines.size() == 0) {
            return "Day 08 is not available";
        }
        ...
        if (str.isEmpty())
            return "Day 08 part " + part + " is Unimplemented";
        return str.toString();
    }
